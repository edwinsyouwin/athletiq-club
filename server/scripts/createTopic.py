...
def generateTopicList(topic, location, list_length=10, save=False):
    ...
    if save:
        topic_df.to_csv(f"scriptfiles/topics/{topic}_list.csv", index=True, header=True, index_label="Index")
